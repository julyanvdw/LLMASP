...
theme_sets = [
    ...
    # 2. Aquarium Ecosystem
    {
        ...
        'verb': 'setup',
        'variations': {
            'V1': ['NeonTetra', 'Goldfish'],
            'V1b': ['Betta', 'Angelfish'],
            'V1c': ['Guppy'],
            'V2': ['JavaFern', 'Duckweed'],
            'V2b': ['Anubias', 'Cryptocoryne'],
            'V2c': ['AmazonSword', 'WaterSprite'],
            'V3': ['SpongeFilter'],
            'V3b': ['CanisterFilter'],
            'V3c': ['HangOnBack'],
            'C1': ['5', '6', '9'],
    ...
    # 3. Fantasy Adventurer Loadout
    {
        ...
        'verb': 'equip',
        'variations': {
            'V1': ['SwordOfLight', 'CrystalBlade'],
            'V1b': ['AxeOfStorms', 'ThunderHammer'],
            'V1c': ['ShadowDagger'],
            'V2': ['DragonScale', 'TitanPlate'],
            'V2b': ['ElvenCloak'],
            'V2c': ['IronPlate'],
            'V3': ['Wolf', 'Bear'],
            'V3b': ['Falcon', 'Owl'],
    ...
    # 5. Space Mission Module
    {
        ...
        'verb': 'assemble',
        'variations': {
            'V1': ['LunarDome', 'OrbitalPod'],
            'V1b': ['MarsPod', 'VenusHab'],
            'V1c': ['AstroCabin'],
            'V2': ['IonDrive'],
            'V2b': ['FusionThruster', 'AntimatterDrive'],
            'V2c': ['ChemicalRocket'],
            'V3': ['Spectrometer'],
            'V3b': ['Drill', 'CoreExtractor'],
            'V3c': ['Telescope'],
            'C1': ['1000', '1100'],
            'C1b': ['1200'],
            'C1c': ['900'],
